...
const uint8_t epd097r_init_sequence_full[] PROGMEM = {
    0x03, UC81xx_PSR, 0xcf, 0x8d,
    0x06, UC81xx_PWR, 0x03, 0x10, 0x3f, 0x3f, 0x0d,
    0x01, UC81xx_PON, // power on
    BUSY_WAIT,
    0x03, UC81xx_TRES, 88, 184, // resolution
    0x04, UC81xx_BTST, 0x17,0x17,0x17, // booster soft-start config - START_10MS | STRENGTH_3 | OFF_6_58US
    //    0x02, 0x00, 0x0f, // LUT from OTP
    0x02, UC81xx_CDI, 0x5c, // inverted, white border
    0x00
};

const uint8_t epd213r2_init_sequence_full[] PROGMEM = {
    0x02, UC81xx_PSR, 0xcf,
    0x06, UC81xx_PWR, 0x03, 0x10, 0x3f, 0x3f, 0x0d,
    0x01, UC81xx_PON, // power on
    BUSY_WAIT,
    0x04, UC81xx_TRES, 122, 0, 250, // resolution
    0x04, UC81xx_BTST, 0x17,0x17,0x17, // booster soft-start config - START_10MS | STRENGTH_3 | OFF_6_58US
    //    0x02, 0x00, 0x0f, // LUT from OTP
    0x02, UC81xx_CDI, 0x17,
    0x00
};
const uint8_t epd213r2_init_sequence_fast[] PROGMEM = {
    0x02, UC81xx_PSR, 0xbf, // LUT from register (0x20 or'd with first byte)
    0x06, UC81xx_PWR, 0x03, 0x00, 0x26, 0x32, 3,
    0x01, UC81xx_PON, // power on
    BUSY_WAIT,
//    0x02, UC81xx_VDCS, 0x04, // VCOM DC = -0.3V
 //   0x02, UC81xx_PLL, 0x3a, // PLL set to 72Hz
    0x04, UC81xx_TRES, 122, 0, 250, // resolution
    0x04, UC81xx_BTST, 0x17,0x17,0x17, // booster soft-start config - START_10MS | STRENGTH_3 | OFF_6_58US
    //    0x02, 0x00, 0x0f, // LUT from OTP
    0x02, UC81xx_CDI, 0x17,
...
const uint8_t epd42r2_init_sequence_full[] PROGMEM = {
    ...
    0x01, UC81xx_PON, // power on
    BUSY_WAIT,
    0x05, UC81xx_TRES, 0x01, 0x90, 1, 0x2c, // resolution
    0x04, UC81xx_BTST, 0x17,0x17,0x17, // booster soft-start config - START_10MS | STRENGTH_3 | OFF_6_58US
    //    0x02, 0x00, 0x0f, // LUT from OTP
    0x02, UC81xx_CDI, 0x5c, // inverted, white border
    0x00
...
const uint8_t epd37xx_init_sequence_full[] PROGMEM = {
    0x03, UC81xx_PSR, 0xdf, 0x8d,
    0x06, UC81xx_PWR, 0x03, 0x10, 0x3f, 0x3f, 0x0d,
    0x01, UC81xx_PON, // power on
    BUSY_WAIT,
    0x04, UC81xx_TRES, 0xf0, 1, 0xa0, // resolution
    
    0x04, UC81xx_BTST, 0x17,0x17,0x17, // booster soft-start config - START_10MS | STRENGTH_3 | OFF_6_58US
    0x02, UC81xx_PFS, 0x00, // FRAMES_1
    0x02, UC81xx_TSE, 0x00, // TEMP_INTERNAL | OFFSET_0
    0x02, UC81xx_TCON, 0x22,
    0x02, UC81xx_CDI, 0xd7, // inverted, white border
    0x02, UC81xx_PLL, 0x09, // HZ_50
    0x00 // end of table
};

// initialization sequence for 2.9" 296x128 e-paper
const uint8_t epd29_init_sequence_full[] PROGMEM = {
    0x02, UC81xx_PSR, 0x80 | 0x00 | 0x10 | 0x08 | 0x04 | 0x02 | 0x01, // RES_128x296, LUT_OTP, FORMAT_BW, SHIFT_LEFT, BOOSTER_ON, RESET_NONE
    0x06, UC81xx_PWR, 0x03, 0x00, 0x2b, 0x2b, 0x2b,
    0x01, UC81xx_PON, // power on
    BUSY_WAIT,
    0x04, UC81xx_BTST, 0x17,0x17,0x17, // booster soft-start config - START_10MS | STRENGTH_3 | OFF_6_58US
    0x02, UC81xx_PFS, 0x00, // FRAMES_1
    0x04, UC81xx_TRES, 0x80, 1, 0x28, // resolution
    0x02, UC81xx_TSE, 0x00, // TEMP_INTERNAL | OFFSET_0
    0x02, UC81xx_TCON, 0x22,
    0x02, UC81xx_CDI, 0x9c, // inverted, white border
    0x02, UC81xx_PLL, 0x3a, // HZ_100
    0x00 // end of table
};

const uint8_t epd29_init_sequence_part[] PROGMEM = {
    0x02, UC81xx_PSR, 0x80 | 0x20 | 0x10 | 0x08 | 0x04 | 0x02 | 0x01, // RES_128x296, LUT_REG, FORMAT_BW, SHIFT_LEFT, BOOSTER_ON, RESET_NONE
    0x06, UC81xx_PWR, 0x03, 0x00, 0x2b, 0x2b, 0x03,
    0x04, UC81xx_BTST, 0x17,0x17,0x17, // booster soft-start config - START_10MS | STRENGTH_3 | OFF_6_58US
    0x01, UC81xx_PON, // power on
    BUSY_WAIT,
    0x04, UC81xx_TRES, 0x80, 1, 0x28, // resolution
    0x02, UC81xx_PLL, 0x3a, // HZ_100
    0x02, UC81xx_VDCS, 0x12, // VCOM DC setting
    0x02, UC81xx_CDI, 0x1C, // white border & non-inverted partial update old->new changes
    0x2d, UC81xx_LUT_VCOM, // VCOM LUT
    ...
    0x2b, UC81xx_LUT_BB,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2b, UC81xx_LUT_VCOM2, // VCOM2 LUT = border
        0x00, 0x1e, 0x00, 0x00, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const uint8_t epd29_init_sequence_gray[] PROGMEM = {
    ...
    0x02, UC81xx_PLL, 0x3a, // HZ_100
    0x02, UC81xx_VDCS, 0x12, // VCOM DC setting
    0x02, UC81xx_CDI, 0x0c, // white border & non-inverted partial update old->new changes
...
const uint8_t epd29r2_init_sequence_full[] PROGMEM = {
    6, UC81xx_PWR, 0x03, 0x00, 0x2b, 0x2b, 0x09,
    4, UC81xx_BTST, 0x17, 0x17, 0x17,
    1, UC81xx_PON,
    BUSY_WAIT,
    2, UC81xx_PSR, 0xcf,
    2, UC81xx_CDI, 0x5c, // inverted, white border
    2, UC81xx_PLL, 0x29,
    2, UC81xx_VDCS, 0x0a,
    BUSY_WAIT, 
    4, UC81xx_TRES, 0x80, 0x01, 0x28,
    0
};
...
const uint8_t epd75_init_sequence_full[] PROGMEM = {
    5, UC81xx_PWR, 0x07, 0x07, 0x3f, 0x3f,
    1, UC81xx_PON,
    BUSY_WAIT,
    2, UC81xx_PSR, 0x1f,
    5, UC81xx_TRES, 0x03, 0x20, 0x01, 0xe0,
    2, 0x15, 0x00, 
    3, UC81xx_CDI, 0x21, 0x07,
    2, UC81xx_TCON, 0x22,
    0
};
const uint8_t epd75_init_sequence_partial[] PROGMEM = {
    0x05, UC81xx_PWR, 0x07, 0x07, 0x3f, 0x3f, 
//    0x02, 0x82, 0x1c, // VCOM DC
    0x01, UC81xx_PON, // power on
    BUSY_WAIT,
    0x02, UC81xx_PSR, 0x3f, // from register 
    0x05, UC81xx_TRES, 0x03, 0x20, 0x01, 0xe0,
    0x02, 0x15, 0x00,
    0x03, UC81xx_CDI, 0x29, 0x07, // VCOM Data interval
    0x02, UC81xx_TCON, 0x22,
    0x2b, UC81xx_LUT_VCOM, // VCOM LUT
    0x00, 30, 1, 30, 1, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const uint8_t epd154a_init_sequence_full[] PROGMEM =
{
    1, UC81xx_PON,
    BUSY_WAIT,
    2, UC81xx_PSR, 0xdf, // panel setting
    4, UC81xx_TRES, 0x98, 0, 0x98, // resolution
    2, UC81xx_CDI, 0x97, // VCOM
    0
};
const uint8_t epd154a_init_sequence_part[] PROGMEM =
{
    1, UC81xx_PON,
    BUSY_WAIT,
    2, UC81xx_PSR, 0x3f, // panel setting
    6, UC81xx_PWR, 0x03, 0x00, 0x21, 0x21, 0x03,
    4, UC81xx_TRES, 0x98, 0, 0x98, // resolution
    2, UC81xx_VDCS, 0x12,
    2, UC81xx_CDI, 0x17, // VCOM
...
const uint8_t epd37yr_init_full[] PROGMEM = 
{
   ...
   0x02, 0x50, 0x37,
   0x03, 0x60, 0x02, 0x02,
   0x05, UC81xx_TRES, 0x00, 0xf0, 0x01, 0xa0, // resolution
...
{           
   ...
   0x02, 0x50, 0x37,
   0x05, UC81xx_TRES, 0x03, 0x20, 0x02, 168, // resolution
...
const uint8_t epd35yr_init_full[] PROGMEM =
{
   ...
   0x02, 0x50, 0x37,
   0x03, 0x60, 0x02, 0x02,
   0x05, UC81xx_TRES, 0x00, 184, 0x01, 0x80, // resolution
   0x02, 0xe7, 0x1c,
   0x02, 0xe3, 0x22,
   0x02, 0xb6, 0x6f,
   0x02, 0xb4, 0xd0,
...
const uint8_t epd42yr_init_full[] PROGMEM =
{
   ...
   0x02, 0x30, 0x08,
   0x02, 0x50, 0x37,
   0x05, UC81xx_TRES, 0x01, 144, 0x01, 44, // resolution (400x300)
   0x02, 0xae, 0xcf,
   0x02, 0xb0, 0x13,
   0x02, 0xbd, 0x07,
   0x02, 0xbe, 0xfe,
...
{   
   ...
   0x02, 0x50, 0x37,
   0x03, 0x60, 0x02, 0x02,
   0x05, UC81xx_TRES, 0x03, 0x20, 0x01, 0xe0, // resolution (800x480)
...
const uint8_t epd266yr_init_full[] PROGMEM = 
{
   ...
   0x02, 0x50, 0x37,
   0x03, 0x60, 0x02, 0x02,
   0x05, UC81xx_TRES, 0x00, 184, 0x01, 104, // resolution
   0x05, 0x65, 0x00, 0x00, 0x00, 0x00,
   0x02, 0xe7, 0x1c,
   0x02, 0xe3, 0x22,
   0x02, 0xe0, 0x00,
...
const uint8_t epd27_ws_init_sequence_full[] = {
    ...
    5, UC81xx_TRES, 0x01, 0x08, 0x00, 0xb0,
    2, 0x50, 0x97, // VCOM
    0
};
...
const uint8_t epd583_init_sequence_full[] PROGMEM = {
    2, UC81xx_PSR, 0x9f,
    6, UC81xx_PWR, 0x03, 0x00, 0x2b, 0x2b, 0x2b,
    1, UC81xx_PON,
    BUSY_WAIT,
    4, UC81xx_BTST, 0x17, 0x17, 0x17,
    2, UC81xx_PFS, 0x00,
    ...
    2, UC81xx_CDI, 0xd7,
    2, UC81xx_PLL, 0x3a,
    5, UC81xx_TRES, 0x02, 0x88, 0x01, 0xe0,
    2, UC81xx_VDCS, 0x12,
    0
};
...
const uint8_t epd42_init_sequence_full[] PROGMEM = {
    ...
    BUSY_WAIT,
    3, 0x00, 0x1f, 0x0b, // panel setting
    5, UC81xx_TRES, 0x01, 0x90, 0x01, 0x2c,
    2, 0x50, 0x97, // VCOM
    0
};
...
const uint8_t epd213_inky_init_sequence_full[] PROGMEM = {
    5, UC81xx_PWR, 0x07, 0x00, 0x0a, 0x00,
    4, UC81xx_BTST, 0x07, 0x07, 0x07,
    1, UC81xx_PON, // power on
    BUSY_WAIT,
    2, UC81xx_PSR, 0xcf,
    2, 0x50, 0x07,
    2, 0x30, 0x29,
    4, UC81xx_TRES, 104, 0, 212,
    2, 0x82, 0x0a,
...
const uint8_t epd75_old_gray_init[] PROGMEM = {
    6, UC81xx_PWR, 0x07, 0x07, 0x3f, 0x3f, 0x03,
    1, UC81xx_PON,
    BUSY_WAIT,
    2, UC81xx_PSR, 0x3f,
    5, UC81xx_TRES, 0x03, 0x20, 0x01, 0xe0,
    2, 0x15, 0x00,
    3, UC81xx_CDI, 0x00, 0x07,
    2, UC81xx_TCON, 0x22,
    3, 0x50, 0x00, 0x07, // VCOM LUTBD (00=white border, 30=black border)
    2, UC81xx_VDCS, 0x12, // VCOM DC
    43, 0x20, // LUT 0~3 gray
      0x00, 0x0A, 0x00, 0x00, 0x00, 0x01,
...
const uint8_t epd73_init[] PROGMEM = {
    ...
    7, UC81xx_PWR, 0x3f, 0x00, 0x32, 0x2a, 0x0e, 0x2a, // power setting
    3, UC81xx_PSR, 0x5f, 0x69, // panel setting
    5, UC81xx_PFS, 0x00, 0x54, 0x00, 0x44,
...
//    2, UC81xx_PLL, 0x02,
    2, UC81xx_TSE, 0x00,
    2, UC81xx_CDI, 0x3f,
    3, UC81xx_TCON, 0x02, 0x00,
    5, UC81xx_TRES, 0x03, 0x20, 0x01, 0xe0, // resolution 800x480
    2, UC81xx_VDCS, 0x1e,
    2, 0x84, 0x00, // T_VCDS
    2, 0x86, 0x00, // AGID
    2, UC81xx_PWS, 0x2f,
...
const uint8_t epd40_spectra_init[] PROGMEM = {
    ...
    2, UC81xx_PWR, 0x3f, // PWR: internal DC-DC for VGH/VGL/VS, chip defaults for voltages
    3, UC81xx_PSR, 0x5f, 0x69, // PSR: 2-byte panel setting, scan up, shift left
    ...
    5, UC81xx_PFS, 0x00, 0x54, 0x00, 0x44, // POFS: power off timing + EPD discharge
    3, UC81xx_TCON, 0x02, 0x00, // TCON: gate/source non-overlap timing
    2, UC81xx_PLL, 0x08, // PLL: dynamic frame rate enabled (Dyna=1)
    2, UC81xx_CDI, 0x3f, // CDI: border floating, VCOM interval 2 Hsync
    5, UC81xx_TRES, 0x01, 0x90, 0x02, 0x58, // TRES: 400x600
    2, UC81xx_PWS, 0x2f, // PWS: VCOM/source power saving widths
    2, 0x84, 0x01, // T_VDCS(undoc): temperature-related VCOM setting
    1, UC81xx_PON, // PON: power on
    BUSY_WAIT,
...
const uint8_t epd41_init_sequence_full[] PROGMEM = {
    BUSY_WAIT,
    3, UC81xx_PSR, 0x2f, 0x00,
    5, UC81xx_PWR, 0x37, 0x00, 0x05, 0x05,
    2, UC81xx_PFS, 0x00,
    4, UC81xx_BTST, 0xc7, 0xc7, 0x1d,
    2, UC81xx_PLL, 0x3c,
    2, UC81xx_TSE, 0x00,
    2, UC81xx_CDI, 0x37,
    2, UC81xx_TCON, 0x22,
    5, UC81xx_TRES, 0x02, 0x80, 0x01, 0x90,
    2, UC81xx_PWS, 0xaa, 
// second set of commands from example (seems unnecessary)
    3, UC81xx_PSR, 0x2f, 0x08,
    6, UC81xx_PWR, 0x37, 0x00, 0x05, 0x05, 0x00,
    5, UC81xx_TRES, 0x02, 0x80, 0x01, 0x90,
    1, UC81xx_PON, // power on
    BUSY_WAIT,
    0x00
...
const uint8_t epd81c_init_full[] PROGMEM = {
    ...
    2, UC81xx_PWR, 0x3f,
    3, UC81xx_PSR, 0x5f, 0x69,
    BUSY_WAIT,
    5, 0x05, 0x40, 0x1f, 0x1f, 0x2c,
    5, 0x08, 0x6f, 0x1f, 0x1f, 0x22,
    5, UC81xx_BTST, 0x6f, 0x1f, 0x16, 0x16,
    5, UC81xx_PFS, 0x00, 0x54, 0x00, 0x44,
    3, UC81xx_TCON, 0x02, 0x00,
    2, UC81xx_PLL, 0x08,
    5, UC81xx_TRES, 0x02, 0x00, 0x02, 0x40,
    BUSY_WAIT,
    2, UC81xx_CDI, 0x3f,
    2, UC81xx_PWS, 0x2f,
    2, UC81xx_VDCS, 0x01,
    2, 0xe0, 0x01,
    5, UC81xx_BTST, 0x6f, 0x1f, 0x16, 0x25,
    1, UC81xx_PON,
    BUSY_WAIT, 
    0x00
};
...
// uc8719
const uint8_t uc8179_init_sequence_full[] PROGMEM = {
    0x06, UC81xx_PWR,
        0x07, 0x07, 0x3f, 0x3f, 0x03,
    0x05, UC81xx_BTST,
        0x17, 0x17, 0x28, 0x17,
    0x01, UC81xx_PON,
    ...
    0x02, UC81xx_PLL,
        0x06, // 50 Hz
    0x05, UC81xx_TRES,
        0x03, 0x20, 0x01, 0xe0, // 800x480
    0x02, UC81xx_DUSPI,
        0x00, // disable Dual SPI
    0x03, UC81xx_CDI,
        0x31, 0x07, // default CDI
    0x02, UC81xx_TCON,
        0x22, // default TCON
    0x02, UC81xx_VDCS,
        0x00, // default VDCS (-0.10 V)
    0x02, UC81xx_PWS,
        0x00, // default PWS
    
    0x00
};
const uint8_t uc8179_init_sequence_partial[] PROGMEM = {
    0x06, UC81xx_PWR,
        0x07, 0x07, 0x3f, 0x3f, 0x03,
    0x05, UC81xx_BTST,
        0x17, 0x17, 0x28, 0x17,
...
const uint8_t uc8179_init_sequence_fast[] PROGMEM = {
    0x06, UC81xx_PWR,
        0x07, 0x07, 0x3f, 0x3f, 0x03,
    0x05, UC81xx_BTST,
        0x17, 0x17, 0x28, 0x17,
    ...
    0x2d, UC81xx_LUT_VCOM,
        ...
        0x00, 0x00,
    0x2b, UC81xx_LUT_WW,
        0x18, 0x01, 0x10, 0x01, 0x00, 0x01,
        0x18, 0x01, 0x1e, 0x01, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
//    {792, 272, 0, epd579yr_init_full, epd579yr_init_fast, NULL, BBEP_4COLOR, BBEP_CHIP_UC81xx, u8Colors_4clr_v2}, // EP579YR_792x272
    ...
    {800, 480, 0, uc8179_init_sequence_full, uc8179_init_sequence_fast, uc8179_init_sequence_partial, 0, BBEP_CHIP_UC81xx, u8Colors_2clr}, // EP75_800x480_UC8179
};
//
...
// DEBUG - for TRMNL mini 180 degree rotated display
    ...
    if (pBBEP->chip_type == BBEP_CHIP_UC81xx) {
        bbepWriteCmd(pBBEP, UC81xx_PTIN); // partial in
        bbepWriteCmd(pBBEP, UC81xx_PTL); // partial window
        i = 0;
        tx *= 8;
        ...
        //       EPDWriteCmd(UC81xx_PTOU); // partial out
    } else { // SSD16xx
...
void bbepSleep(BBEPDISP *pBBEP, int bDeep)
{
    ...
    if (pBBEP->chip_type == BBEP_CHIP_UC81xx) {
        if (pBBEP->iFlags & BBEP_7COLOR) {
            bbepCMD2(pBBEP, UC81xx_POFF, 0x00); // power off
            if (pBBEP->iFlags & BBEP_SPLIT_BUFFER) { // dual cable EPD
               pBBEP->iCSPin = pBBEP->iCS2Pin;
               bbepCMD2(pBBEP, UC81xx_POFF, 0x00); // second controller
            ...
            bbepCMD2(pBBEP, UC81xx_CDI, 0x17); // border floating
            bbepWriteCmd(pBBEP, UC81xx_POFF); // power off
            bbepWaitBusy(pBBEP);
            if (bDeep) {
                bbepCMD2(pBBEP, UC81xx_DSLP, 0xa5); // deep sleep
            }
        }
    } else {
...
int bbepRefresh(BBEPDISP *pBBEP, int iMode)
{
    ...
    if (pBBEP->chip_type == BBEP_CHIP_UC81xx) {
        if (pBBEP->iFlags & (BBEP_4GRAY | BBEP_4COLOR | BBEP_7COLOR)) {
            bbepCMD2(pBBEP, UC81xx_DRF, 0x00);
            if (pBBEP->iFlags & BBEP_SPLIT_BUFFER) {
               // Send the same sequence to the second controller
               pBBEP->iCSPin = pBBEP->iCS2Pin;
               bbepCMD2(pBBEP, UC81xx_DRF, 0);
               pBBEP->iCSPin = pBBEP->iCS1Pin;
            }
        } else {
            bbepWriteCmd(pBBEP, UC81xx_PTOU); // partial out (update the entire panel, not just the last memory window)
            bbepWriteCmd(pBBEP, UC81xx_DRF);
        }
    } else {
